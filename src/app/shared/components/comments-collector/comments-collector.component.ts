...
@Component({
  selector: 'app-comments-collector',
  templateUrl: './comments-collector.component.html',
  styleUrls: ['./comments-collector.component.scss']
})
export class CommentsCollectorComponent implements OnInit {
